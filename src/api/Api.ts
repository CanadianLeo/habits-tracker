...
class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  habits = {
     ...
     * No description
     *
     * @name HabitControllerCreateHabit
     * @request POST:/habits
     */
     ...
     * No description
     *
     * @name HabitControllerGetHabitById
     ...
     * No description
     *
     * @name HabitControllerUpdateHabit
     ...
     * No description
     *
     * @name HabitControllerRemoveHabit
     ...
     * No description
     *
     * @name HabitControllerIncrementHabit
     ...
     * No description
     *
     * @name HabitControllerDecrementHabit
